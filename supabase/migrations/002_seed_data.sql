...
INSERT INTO courses (id, mentor_id, title, description, category, format, price, location, image_url, status, is_promoted, students_count, rating, review_count) VALUES
  ('10000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001',
   ...
   'Khóa học giúp người mới xây nền tảng tư duy chiến thuật, khai cuộc, trung cuộc và cách phân tích thế cờ.',
   'mind-sports', 'offline', 200000, 'Quận 1, TP.HCM',
   'https://images.unsplash.com/photo-1511379938547-c1f69419868d?w=600&h=400&fit=crop',
   'approved', true, 340, 4.9, 128),

  ('10000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000002',
   'Tiếng Anh công việc & IELTS 6.5+',
   'Khóa học tiếng Anh cho học tập và công việc, tập trung giao tiếp, email, thuyết trình và luyện mục tiêu IELTS 6.5+.',
   'career-english', 'online', 350000, NULL,
   'https://images.unsplash.com/photo-1516321318423-f06f85e504b3?w=600&h=400&fit=crop',
   'approved', false, 890, 4.8, 256),

  ('10000000-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000004',
   'Pickleball cơ bản cho người đi làm',
   'Khóa học thể thao hiện đại giúp người mới nắm kỹ thuật cầm vợt, di chuyển, giao bóng và chiến thuật đôi.',
   'modern-sports', 'offline', 180000, 'Quận 7, TP.HCM',
   'https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?w=600&h=400&fit=crop',
   'approved', false, 210, 4.7, 89),

  ('10000000-0000-0000-0000-000000000004', '00000000-0000-0000-0000-000000000003',
   'AI tự động hóa công việc văn phòng',
   'Khóa học ứng dụng AI và công cụ tự động hóa để viết nội dung, phân tích dữ liệu và tối ưu quy trình làm việc.',
   'ai-productivity', 'online', 500000, NULL,
   'https://images.unsplash.com/photo-1517694712202-14dd9538aa97?w=600&h=400&fit=crop',
   'approved', true, 1200, 4.9, 312),

  ('10000000-0000-0000-0000-000000000005', '00000000-0000-0000-0000-000000000006',
   'Barista căn bản: Espresso & Latte Art',
   'Học quy trình pha espresso, đánh sữa, tạo hình latte art và xây dựng menu đồ uống cơ bản.',
   'barista-beverage', 'offline', 300000, 'Quận 3, TP.HCM',
   'https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=600&h=400&fit=crop',
   'approved', false, 150, 4.6, 67),

  ('10000000-0000-0000-0000-000000000006', '00000000-0000-0000-0000-000000000005',
   'Tennis hiện đại cho người mới',
   'Khóa học kỹ thuật tennis cơ bản, footwork, giao bóng và chiến thuật thi đấu hiện đại.',
   'modern-sports', 'online', 250000, NULL,
  ...
  ('10000000-0000-0000-0000-000000000007', '00000000-0000-0000-0000-000000000008',
   ...
   'Khóa học xây dựng kịch bản, nói trước camera, dựng format video ngắn và phát triển giọng kể cá nhân.',
   'content-speaking', 'offline', 280000, 'Quận Bình Thạnh, TP.HCM',
  ...
  ('10000000-0000-0000-0000-000000000008', '00000000-0000-0000-0000-000000000007',
   'MC & thuyết trình trước đám đông',
   'Khóa học luyện giọng nói, cấu trúc bài trình bày, xử lý sân khấu và dẫn chương trình chuyên nghiệp.',
   'content-speaking', 'offline', 400000, 'Quận 2, TP.HCM',
