...
import { Calendar, Clock, Phone, CreditCard, Wallet, ChevronLeft, CheckCircle2, Loader2 } from "lucide-react";
        ...
        <AnimatePresence mode="wait">
          {confirmed ? (
            ...
            <motion.div key="form" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              >
                {createBooking.isPending ? <><Loader2 className="mr-2 h-4 w-4 animate-spin" />Đang xử lý...</> : "Xác nhận đặt lịch"}
              </Button>
            </motion.div>
          )}
        </AnimatePresence>
